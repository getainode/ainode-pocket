...
class _Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        self.rfile.read(length)  # drained, not inspected: this test is about parsing
...
class TestAccountAuthKey(unittest.TestCase):
    ...
    def test_returns_the_auth_key_field(self):
        got = device_mod.account_auth_key(self.addr, "TNYM000", "correct horse")
    ...
    def test_wrong_password_is_empty_string_not_a_crash(self):
        ...
        _Handler.status = 403
        try:
            got = device_mod.account_auth_key(self.addr, "TNYM000", "wrong")
        finally:
    ...
    def test_unreachable_host_is_empty_string(self):
        got = device_mod.account_auth_key("127.0.0.1:1", "TNYM000", "x")
        self.assertEqual(got, "")
